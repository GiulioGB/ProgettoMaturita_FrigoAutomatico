...
namespace Frigo
{
    class ConnessioneDB
    {
        ...
        //SalvaUtenti
        public void Salva(TextBox prima, TextBox seconda, TextBox terza, TextBox quarta, TextBox quinta, TextBox sesta)
        {
            string q = "INSERT INTO utenti_frigo (nome,cognome,sesso,peso,altezza,eta) values('" + prima.Text + "','" + seconda.Text + "','" + terza.Text + "'," + Int32.Parse(quarta.Text) + "," + Int32.Parse(quinta.Text) + "," + Int32.Parse(sesta.Text) + ");";
